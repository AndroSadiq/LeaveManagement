...
public class EmpSignUpActivity extends AppCompatActivity {
    ...
    ImageView ivEdit;
    EditText edtName, edtUsername, edtPassword, edtPhone, edtConfirmPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtName = findViewById(R.id.edt_emp_name);
            ...
            public void onClick(View v) {
                if (flag) {
                    CropImage.activity().setGuidelines(CropImageView.Guidelines.ON)
                            .setAspectRatio(1, 1)
                            .start(EmpSignUpActivity.this);
                } else {
                    LayoutInflater layoutInflater = getLayoutInflater();
                    View view = layoutInflater.inflate(R.layout.dialog_ayout_remove, null);
                    final Dialog dialog = new Dialog(EmpSignUpActivity.this);
        ...
        btnGotoLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpSignUpActivity.this, EmpLoginActivity.class);
                startActivity(intent);
                Bungee.zoom(EmpSignUpActivity.this);
            }
        });
    }
    ...
    private void insertIntoEmpDB () {
        ...
        TextInputLayout nameLayout = findViewById(R.id.tilay_name);
                        ...
                        if (confirmPass.equals("")) {
                            ...
                            if (pass.equals(confirmPass)) {
                                ...
                                if (f == 0) {
                                            ...
                                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                filePath.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Uri> task) {
                                                        ...
                                                        EmpSignUp empSignUp = new EmpSignUp(imageUrl, name, username,phone, pass,"pending");
                                                        databaseReference.child(userId).setValue(empSignUp);
                                                    }
                                                });
                                            }
                                        });
                                    ...
                                    Intent intent = new Intent(EmpSignUpActivity.this, EmpLoginActivity.class);
                                    startActivity(intent);
                                    progressDialog =new ProgressDialog(EmpSignUpActivity.this);
